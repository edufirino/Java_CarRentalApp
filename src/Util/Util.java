...
public class Util {
        ...
        static String[] creditCardNumber = { "4916522687392702 ", "4024007119381688 ", "4024007110775024389",
                        ...
                        "4913846332039720" };
        static String[] customer = { "Terry Judson", "Castillo Hipolito", "Thornton Elwood", "Berg Adan",
                        "Randall Jamal", "Jennings Georgette", "Lutz Rosalyn", "Hodges Marco", "Moses Petra",
                        "Reeves Oswaldo", "Giles Elliot", "Kane Kelly", "Mendoza Rocky", "Riddle Jason",
                        "Campbell Lewis", "Riggs Avery", "Lee Elmo", "Craig Myra", "Turner Leigh", "Stanton Chad",
                        "Braun Deborah", "JohnsonGregg", "Mcpherson Karen", "Holt Monica", "Escobar Anna",
                        "Simpson Jacqueline", "Erickson Alexandria", "Mcfarland Kerry", "Stone Tania", "Miller Trust" };
